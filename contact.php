            ...
            if ($stmt->execute()) {
                ...
                try {
                    ...
                    $mail->Body    = "<h3>Hello $contact_name,</h3>
                                      <p>Thank you for contacting JEJ Surveying. We have successfully received your inquiry!</p>
                                      ...
                                      <br><p>Best Regards,<br><b>JEJ Surveying Team</b></p>";
...
<body>
    ...
    <footer class="footer">
        <p>© <?= date('Y') ?> JEJ Surveying Services. All Rights Reserved. Built with trust and excellence.</p>
    </footer>
